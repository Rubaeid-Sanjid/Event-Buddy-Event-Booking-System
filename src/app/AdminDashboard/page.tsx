      ...
      <div className="text-[#242565] px-16">
        ...
        <div>
          <div className="flex justify-between">
            ...
            <button className="cursor-pointer size-1/12 py-2 text-white rounded-md bg-gradient-to-t from-[#4157FE] to-[#7B8BFF] hover:from-indigo-600 hover:to-indigo-500 transition">
              Create Event
            </button>
          </div>
