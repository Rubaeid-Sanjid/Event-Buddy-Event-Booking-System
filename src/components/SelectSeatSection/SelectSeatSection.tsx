...
const SelectSeatSection = () => {
  ...
  return (
    <div className="bg-white rounded-lg p-6 mb-10 border border-[#BDBBFB59] w-3/4 mx-auto">
      <h3 className="text-2xl font-semibold mb-5">Select Number of Seats</h3>
      ...
      <div className="flex justify-center gap-4 mb-6">
        {seats.map((seat, idx) => (
          <button
            ...
            className={`flex flex-col items-center justify-center cursor-pointer rounded-md border border-[#E6E6E6] px-6 py-4 w-[204px]
                  ${
                    selectedSeats === seat
